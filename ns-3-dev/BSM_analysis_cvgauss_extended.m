...
filename_40n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_40node_cvgauss.output2.csv';
filename_60n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_60node_cvgauss.output2.csv';
filename_70n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_70node_cvgauss.output2.csv';
filename_80n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_80node_cvgauss.output2.csv';
filename_90n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_90node_cvgauss.output2.csv';
filename_100n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_100node_cvgauss.output2.csv';
filename_120n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_120node_cvgauss.output2.csv';
filename_160n = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_160node_cvgauss.output2.csv';
...
filename_40n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_40node_cvgauss.output3.csv';
filename_60n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_60node_cvgauss.output3.csv';
filename_70n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_70node_cvgauss.output3.csv';
filename_80n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_80node_cvgauss.output3.csv';
filename_90n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_90node_cvgauss.output3.csv';
filename_100n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_100node_cvgauss.output3.csv';
filename_120n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_120node_cvgauss.output3.csv';
filename_160n_2 = '/Users/avikdayal/Google-Drive/PHD-Thesis/ARL-work/ns-3-adaptive-veh-50ms/ns-3-dev/bsm_160node_cvgauss.output3.csv';
...
diff_crashes=abs(crashes_tot_c-crashes_tot);
...
% figure('rend','painters','pos',[10 10 1050 750]);plot(safety_range(1:7), lp_PDR(1:7),'-or');title('Adaptive Rate Packet Delivery Ratio vs Distance');xlabel('Distance (m)');ylabel('Packet Delivery Ratio');
% hold on;
...
lp_PDR_SR_1_50ms=[lp_PDR(2) lp_PDR_40n(2) lp_PDR_60n(2) lp_PDR_70n(2) lp_PDR_80n(2) lp_PDR_90n(2) lp_PDR_100n(2) lp_PDR_120n(2) lp_PDR_160n(2)];
lp_PDR_SR_3_50ms=[lp_PDR(3) lp_PDR_40n(3) lp_PDR_60n(3) lp_PDR_70n(3) lp_PDR_80n(3) lp_PDR_90n(3) lp_PDR_100n(3) lp_PDR_120n(3) lp_PDR_160n(3)];
lp_PDR_SR_5_50ms=[lp_PDR(5) lp_PDR_40n(5) lp_PDR_60n(5) lp_PDR_70n(5) lp_PDR_80n(5) lp_PDR_90n(5) lp_PDR_100n(5) lp_PDR_120n(5) lp_PDR_160n(5)];
lp_PDR_SR_7_50ms=[lp_PDR(7) lp_PDR_40n(7) lp_PDR_60n(7) lp_PDR_70n(7) lp_PDR_80n(7) lp_PDR_90n(7) lp_PDR_100n(7) lp_PDR_120n(7) lp_PDR_160n(7)];
...
hp_PDR_SR_1_50ms=[hp_PDR(2) hp_PDR_40n(2) hp_PDR_60n(2) hp_PDR_70n(2) hp_PDR_80n(2) hp_PDR_90n(2) hp_PDR_100n(2) hp_PDR_120n(2) hp_PDR_160n(2)];
hp_PDR_SR_3_50ms=[hp_PDR(3) hp_PDR_40n(3) hp_PDR_60n(3) hp_PDR_70n(3) hp_PDR_80n(3) hp_PDR_90n(3) hp_PDR_100n(3) hp_PDR_120n(3) hp_PDR_160n(3)];
hp_PDR_SR_5_50ms=[hp_PDR(5) hp_PDR_40n(5) hp_PDR_60n(5) hp_PDR_70n(5) hp_PDR_80n(5) hp_PDR_90n(5) hp_PDR_100n(5) hp_PDR_120n(5) hp_PDR_160n(5)];
hp_PDR_SR_7_50ms=[hp_PDR(7) hp_PDR_40n(7) hp_PDR_60n(7) hp_PDR_70n(7) hp_PDR_80n(7) hp_PDR_90n(7) hp_PDR_100n(7) hp_PDR_120n(7) hp_PDR_160n(7)];


figure('rend','painters','pos',[10 10 1050 750]);plot(density, lp_PDR_SR_1_50ms,'-or');title('Adaptive Rate Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
plot(density, lp_PDR_SR_3_50ms,'-ob');
plot(density, lp_PDR_SR_5_50ms,'-ok');
plot(density, lp_PDR_SR_7_50ms,'-og');
plot(density, hp_PDR_SR_1_50ms,'-.xr');
plot(density, hp_PDR_SR_3_50ms,'-.xb');
plot(density, hp_PDR_SR_5_50ms,'-.xk');
plot(density, hp_PDR_SR_7_50ms,'-.xg');
ylim([0.05 1.01])
hold off;
...
figure('rend','painters','pos',[10 10 1050 750]);plot(density, hp_PDR_SR_1_50ms,'-or');title('High Priority Packet Delivery Ratio vs Node Density');xlabel('Density(nodes/km)');ylabel('Packet Delivery Ratio');
hold on;
plot(density, hp_PDR_SR_3_50ms,'-ob');
plot(density, hp_PDR_SR_5_50ms,'-ok');
plot(density, hp_PDR_SR_7_50ms,'-og');
...
figure('rend','painters','pos',[10 10 1050 750]);plot(density, crashes_tot,'-or');title('Crashes vs Node Density');xlabel('Density(nodes/km)');ylabel('Number of Crashes');
hold on;
plot(density, crashes_tot_c,'-xb');
set(findall(gcf,'-property','FontSize'),'FontSize',24)
legend(['Adaptive Rate'],['Constant 10 Hz Rate']);
hold off;

figure('rend','painters','pos',[10 10 1050 750]);plot(density, diff_crashes,'-or');title('Crash Difference vs Node Density');xlabel('Density(nodes/km)');ylabel('Number of Crashes');
set(findall(gcf,'-property','FontSize'),'FontSize',24)
%ylim([0.05 1.01])
%legend('20 nodes-.1 sec beacon rate','40 nodes-.1 sec beacon rate','80 nodes-.1 sec beacon rate','160 nodes-.1 sec beacon rate','20 nodes-.05 sec beacon rate','40 nodes-.05 sec beacon rate','80 nodes-.05 sec beacon rate','160 nodes-.05 sec beacon rate');
...
save hp_PDR_SR_1_50ms hp_PDR_SR_1_50ms
save hp_PDR_SR_3_50ms hp_PDR_SR_3_50ms
save hp_PDR_SR_5_50ms hp_PDR_SR_5_50ms
save hp_PDR_SR_7_50ms hp_PDR_SR_7_50ms
save lp_PDR_SR_1_50ms lp_PDR_SR_1_50ms
save lp_PDR_SR_3_50ms lp_PDR_SR_3_50ms
save lp_PDR_SR_5_50ms lp_PDR_SR_5_50ms
save lp_PDR_SR_7_50ms lp_PDR_SR_7_50ms
