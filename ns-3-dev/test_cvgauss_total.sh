...
#echo "#define STD_DEV 5" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=20 --CSVfileName=bsm_20node_cvgauss.output.csv --CSVfileName2=bsm_20node_cvgauss.output2.csv --CSVfileName3=bsm_20node_cvgauss.output3.csv" > trace_20n.log 2> bsm_20n.log
#echo "//#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=40 --CSVfileName=bsm_40node_cvgauss.output.csv --CSVfileName2=bsm_40node_cvgauss.output2.csv --CSVfileName3=bsm_40node_cvgauss.output3.csv" > trace_40n.log 2> bsm_40n.log
#echo "about to start 40 node control"
#echo "//#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=100 --nodes=40 --pcap=0 --CSVfileName=bsm_control_40node_cvgauss.output.csv --CSVfileName2=bsm_control_40node_cvgauss.output2.csv --CSVfileName3=bsm_control_40node_cvgauss.output3.csv" > trace_c40n.log 2> bsm_c40n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=70 --CSVfileName=bsm_70node_cvgauss.output.csv --CSVfileName2=bsm_70node_cvgauss.output2.csv --CSVfileName3=bsm_70node_cvgauss.output3.csv" > trace_70n.log 2> bsm_70n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=80 --CSVfileName=bsm_80node_cvgauss.output.csv --CSVfileName2=bsm_80node_cvgauss.output2.csv --CSVfileName3=bsm_80node_cvgauss.output3.csv" > trace_80n.log 2> bsm_80n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=80 --pcap=0 --CSVfileName=bsm_control_80node_cvgauss.output.csv --CSVfileName2=bsm_control_80node_cvgauss.output2.csv --CSVfileName3=bsm_control_80node_cvgauss.output3.csv"> trace_c80n.log 2> bsm_c80n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=90 --CSVfileName=bsm_90node_cvgauss.output.csv --CSVfileName2=bsm_90node_cvgauss.output2.csv --CSVfileName3=bsm_90node_cvgauss.output3.csv" > trace_90n.log 2> bsm_90n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=90 --pcap=0 --CSVfileName=bsm_control_80node_cvgauss.output.csv --CSVfileName2=bsm_control_90node_cvgauss.output2.csv --CSVfileName3=bsm_control_90node_cvgauss.output3.csv"> trace_c90n.log 2> bsm_c90n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=100 --CSVfileName=bsm_100node_cvgauss.output.csv --CSVfileName2=bsm_100node_cvgauss.output2.csv --CSVfileName3=bsm_100node_cvgauss.output3.csv" > trace_100n.log 2> bsm_100n.log
...
#echo "#define MIN_INTERVAL 50" >> "src/wave/model/adaptive_priotag.h"
#echo "#define MAX_INTERVAL 500" >> "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=50 --nodes=100 --pcap=0 --CSVfileName=bsm_control_100node_cvgauss.output.csv --CSVfileName2=bsm_control_100node_cvgauss.output2.csv --CSVfileName3=bsm_control_100node_cvgauss.output3.csv"> trace_c100n.log 2> bsm_c100n.log
